...
var (
	...
	ErrAlgorithmNoModeratePermission = &AppError{StatusCode: http.StatusForbidden, Code: "ALGORITHM_NO_PERMISSION_MODERATE", Message: "You don't have permission to moderate algorithms."}
