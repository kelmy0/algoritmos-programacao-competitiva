	...
	<div class="w-full max-w-md p-8 bg-app-surface border border-app-border rounded-xl shadow-xl">
		...
		<div class="grid grid-cols-2 gap-3">
			...
			<a
				...
				class="flex items-center justify-center gap-2 py-2.5 px-3 bg-app-bg/50 border border-app-border rounded-lg text-xs font-medium text-text-secondary hover:bg-app-overlay/40 hover:border-app-border-hover hover:text-text-primary transition-all focus:outline-none focus:ring-1 focus:ring-text-brand"
