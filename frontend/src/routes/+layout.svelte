...
<div class="min-h-screen bg-app-bg text-text-primary font-inter flex flex-col">
	...
	<div class="flex flex-1 pt-16">
		...
		<aside
			...
			class="fixed top-16 bottom-0 right-0 md:z-40 z-50 w-64 bg-app-surface border-l border-gray-800 md:border-l-0 md:border-r transform transition-transform duration-200 ease-in-out md:sticky md:left-0 md:right-auto md:translate-x-0
